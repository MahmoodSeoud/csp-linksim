# rdp-baseline.csh - CSH-RDP (CSP RDP + CRC32) integrity, clean single-shot. Runnable + reproducible.
#
...
#
#   run /home/mseo/thesis/csp-linksim/experiments/rdp-baseline.csh
#
...
#   experiments/rdp-cell.csh  (this arm under seeded loss)  or  scripts/rdp-board-sweep
csp init
csp add can -d 20
