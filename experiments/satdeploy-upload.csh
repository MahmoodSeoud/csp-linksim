...
# could never converge. -B 4 is the burst shape the recorded experiments used.
...
# -m 256 pins the fragmentation layout (1058 fragments for the 256 KiB artifact); the
# compiled-in default drifted to 1024 once and silently changed the layout.
# SVU bulk data rides port 9; recording it makes the fragmentation layout visible and is
